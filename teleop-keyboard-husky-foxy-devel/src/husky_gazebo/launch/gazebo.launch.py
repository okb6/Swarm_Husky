...
from launch.actions import DeclareLaunchArgument, TimerAction, ExecuteProcess, IncludeLaunchDescription, RegisterEventHandler, SetEnvironmentVariable
...
def generate_launch_description():
    ...
    husky_ns = LaunchConfiguration('husky_name')
    husky_ns_launch_arg = DeclareLaunchArgument(
        'husky_name',
        default_value='h0'
    )
    ...
    spawn_husky_velocity_controller = Node(
        ...
        arguments=['husky_velocity_controller_2', '-c', '/husky_2/controller_manager'],
        output='screen',
    )
    ...
    # Add timer event to delay the start of joint state broadcaster
    spawn_joint_state_broadcaster = Node(
        package='controller_manager',
        executable='spawner.py',
        arguments=['joint_state_broadcaster_2', '-c', '/husky_2/controller_manager'],
        output='screen',
    )
    ...
    ld.add_action(delayed_spawn_joint_state_broadcaster)
